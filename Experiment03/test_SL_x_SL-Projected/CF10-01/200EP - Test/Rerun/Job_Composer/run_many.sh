#!/bin/bash
#SBATCH --job-name=Rerun_Test_10WP_3RB_vs_5RB
...
NOTEBOOKS=(
  "SFLV2_Projected-CF10-01-200EP-10WP-3RB-0-01LR-2048FM.ipynb"
  "SFLV2_Projected-CF10-01-200EP-10WP-3RB-0-01LR-4096FM_Original.ipynb"
  "SFLV2_Projected-CF10-01-200EP-10WP-5RB-0-01LR-2048FM.ipynb"
  "SFLV2_Projected-CF10-01-200EP-10WP-5RB-0-01LR-4096FM_Original.ipynb"
)
