#!/bin/bash
#SBATCH --job-name=CIFAR10-A01-CUTs-Final
...
NOTEBOOKS=(
  "SL + Projected - CIFAR-10 - Alpha=0.1 - Early Cut.ipynb"
  "SL + Projected - CIFAR-10 - Alpha=0.1 - Mid Cut.ipynb"
  "SL + Projected - CIFAR-10 - Alpha=0.1 - Late Cut.ipynb"
)
