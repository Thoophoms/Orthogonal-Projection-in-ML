#!/bin/bash
#SBATCH --job-name=CIFAR100-A01-CUT-New
...
NOTEBOOKS=(
  "SFLV2 + Projected - CIFAR-100 - Alpha=0.1 - Early - Cut.ipynb"
  "SFLV2 + Projected - CIFAR-100 - Alpha=0.1 - Mid - Cut.ipynb"
  "SFLV2 + Projected - CIFAR-100 - Alpha=0.1 - Late - Cut.ipynb"
)
