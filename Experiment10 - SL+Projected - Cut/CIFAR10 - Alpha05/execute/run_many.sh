#!/bin/bash
#SBATCH --job-name=CIFAR10-A05-CUTs-Final
...
NOTEBOOKS=(
  "SL + Projected - CIFAR-10 - Alpha=0.5 - Early Cut.ipynb"
  "SL + Projected - CIFAR-10 - Alpha=0.5 - Mid Cut.ipynb"
  "SL + Projected - CIFAR-10 - Alpha=0.5 - Late Cut.ipynb"
)
