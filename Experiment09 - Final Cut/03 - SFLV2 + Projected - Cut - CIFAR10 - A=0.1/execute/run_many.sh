#!/bin/bash
#SBATCH --job-name=CIFAR10-A01-CUT-Final
...
NOTEBOOKS=(
  "SFLV2 + Projected - CIFAR-10 - Alpha=0.1 - Early - Cut.ipynb"
  "SFLV2 + Projected - CIFAR-10 - Alpha=0.1 - Late - Cut.ipynb"
  "SFLV2 + Projected - CIFAR-10 - Alpha=0.1 - Mid - Cut.ipynb"
)
