#!/bin/bash
#SBATCH --job-name=CIFAR100-A05-CUT-New
...
NOTEBOOKS=(
  "SFLV2 + Projected - CIFAR-100 - Alpha=0.5 - Early - Cut.ipynb"
  "SFLV2 + Projected - CIFAR-100 - Alpha=0.5 - Late - Cut.ipynb"
  "SFLV2 + Projected - CIFAR-100 - Alpha=0.5 - Mid - Cut.ipynb"
)
