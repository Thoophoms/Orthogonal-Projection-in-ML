#!/bin/bash
#SBATCH --job-name=CIFAR10-A05-CUT-Final
...
NOTEBOOKS=(
  "SFLV2 + Projected - CIFAR-10 - Alpha=0.5 - Early - Cut.ipynb"
  "SFLV2 + Projected - CIFAR-10 - Alpha=0.5 - Late - Cut.ipynb"
  "SFLV2 + Projected - CIFAR-10 - Alpha=0.5 - Mid - Cut.ipynb"
)
