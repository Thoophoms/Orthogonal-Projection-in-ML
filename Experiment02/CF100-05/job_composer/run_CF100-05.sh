...
# Parent directory of job_composer/ -> CF100-05/
PROJECT_DIR="$(dirname "$SLURM_SUBMIT_DIR")"


NOTEBOOKS=(
  "Centralize_Baseline-CF100-05.ipynb"
  "FL-CF100-05.ipynb"
  "FOT-CF100-05.ipynb"
  "SFLV2_Projected-CF100-05.ipynb"
  "SFLV2-CF100-05.ipynb"
  "SL_Projected-CF100-05.ipynb"
  "SL-CF100-05.ipynb"
)
